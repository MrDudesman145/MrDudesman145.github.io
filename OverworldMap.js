        ...
        talking: [
          {
            ...
            events: [
              { type: "textMessage", text: "Aren't I the Coolest?", faceHero: "npcA" },
            ]
          },
          {
            events: [
              { type: "textMessage", text: "Yeah, you're Cooked Lil Bro", faceHero: "npcA" },
              { type: "battle", enemyId: "beth" },
              { type: "addStoryFlag", flag: "DEFEATED_BETH"},
              { type: "textMessage", text: "This is why people like you are not nice", faceHero: "npcA" },
      ...
      [utils.asGridCoord(7,4)]: [
        {
          events: [
            ...
            { type: "textMessage", text:"Why are you even here"},
    ...
    configObjects: {
        ...
        talking: [
          {
            required: ["Manager"],
            events: [
              { type: "textMessage", text: "Congratulations you have proven yourself of the True Sambbao",},
            ]
          },
          {
            required: ["chefRootie"],
            events: [
              { type: "battle", enemyId: "Manager", arena: "green-kitchen" },
              { type: "addStoryFlag", flag: "Manager"},
              { type: "textMessage", text: "Battle",},
            ]
          },
          {
            events: [
              { type: "textMessage", text: "** They are too sigma for you **",},
            ]
          },
        ]
      },
      ...
      kitchenNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "WHY SO SERIOUS?!?", faceHero: "kitchenNpcB" },
            ]
          }
        ],
        behaviorLoop: [
    ...
    cutsceneSpaces: {
      ...
      [utils.asGridCoord(10,6)]: [{
        ...
        events: [
          ...
          { type: "textMessage", text: "* You are chopping ingredients on your first day as Chef in a Famous Pizza Plaza *"},
          ...
          { type: "textMessage", text: "This Pizza is burnt!"},
          { type: "textMessage", text: "Don't even get me started on the Ingredients."},
          { type: "textMessage", text: "You will never make it in as a Chef!"},
          { type: "stand", who: "kitchenNpcA", direction: "right", time: 200},
          ...
          { type: "textMessage", text: "* The Manager is fierce! You should spend some time leveling up your Pizza lineup and skills. *"},
          {
            type: "changeMap",
            map: "Street",
            x: utils.withGrid(5),
    ...
    configObjects: {
      ...
      streetNpcA: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "I had way too much pizza, I don't know who I'm talking to right now", faceHero: "streetNpcA" },
            ]
          }
        ]
      },
      streetNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "The Pizza Here is AMAZING!! thats the only reason I'm here", faceHero: "streetNpcB" },
            ]
          }
        ]
      },
        ...
        talking: [
          {
            ...
            events: [
              { type: "textMessage", text: "You got lucky", faceHero: "streetNpcC" },
          ...
          {
            events: [
              { type: "textMessage", text: "Who does bro think he is?", faceHero: "streetNpcC" },
              { type: "battle", enemyId: "streetBattle" },
              { type: "addStoryFlag", flag: "streetBattle"},
            ]
          },
    ...
    configObjects: {
      ...
      shopNpcA: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "All these chef Rivals or Whatever been good for that buisness", faceHero: "shopNpcA" },
            ]
          }
        ]
      },
      shopNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "I don't know why i'm here tbh", faceHero: "shopNpcB" },
            ]
          }
        ]
      },
    ...
    configObjects: {
      ...
      greenKitchenNpcA: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Chef Rootie is so W and has peak recipes ", faceHero: "greenKitchenNpcA" },
            ]
          }
        ]
      },
      greenKitchenNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "I SPENT ALL MY MONEY ON JUST PIZZA, I DON't REGRET A THING!!!", faceHero: "greenKitchenNpcB" },
            ]
          }
        ]
      },
      greenKitchenNpcC: {
        ...
        talking: [
          {
            required: ["chefRootie"],
            events: [ {type: "textMessage", faceHero:["greenKitchenNpcC"], text: "IMPOSSIBLE YOU MUST BE THE TRUE SAMBBAO"} ]
          },
          {
            events: [
              { type: "textMessage", text: "I am the Veggie king, Who dares challenge Thy!?!", faceHero: "greenKitchenNpcC" },
    ...
    configObjects: {
      ...
      streetNorthNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "I am ... ... ... ... ...", faceHero: "streetNorthNpcB" },
            ]
          }
        ]
      },
        ...
        talking: [
          {
            ...
            events: [
              { type: "textMessage", text: "Could you be the Legendary Sambbao?", faceHero: "streetNorthNpcC" },
            ]
          },
          {
            events: [
    ...
    configObjects: {
        ...
        talking: [
          {
            ...
            events: [
              { type: "textMessage", text: "I need training", faceHero: "diningRoomNpcA" },
            ]
          },
          {
            events: [
              { type: "textMessage", text: "Who Dares challenge Thy!?!", faceHero: "diningRoomNpcA" },
      ...
      diningRoomNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "People come here just for the Pizza, pretty sad...", faceHero: "diningRoomNpcB" },
            ]
          },
        ]
      },
      diningRoomNpcC: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Pizza", faceHero: "diningRoomNpcC" },
            ]
          },
        ]
      },
      diningRoomNpcD: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "I had WAYYYYYYYYYYYY TOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO Much Pizza", faceHero: "diningRoomNpcD" },
            ]
          },
        ]
      },
